      ...
      <Grid Container className="content">
        ...
        <Grid className="row1" xs={12}>
          ...
          <Grid className="column2" md={6} xs={12}>
            <Grid className="item2" xs={12}>
              <AspectRatio
                ratio="1"
                sx={{ minWidth: 200, borderRadius: "sm", overflow: "auto" }}
              >
                <img
                  style={{ background: "black" }}
                  height="100"
        ...
        <Grid className="row2" xs={12}>
          <Grid className="item2" md={3} xs={12}></Grid>
          <Grid className="item2" md={3} xs={12}></Grid>
          <Grid className="item2" md={3} xs={12}></Grid>
          <Grid className="item2" md={3} xs={12}></Grid>
        </Grid>
        <Grid className="row1" xs={12}>
          <Grid className="column1" xs={3}>
            <Grid className="item1" xs={12}></Grid>
            <Grid className="item1" xs={12}></Grid>
          </Grid>
          <Grid className="column2" xs={6}>
            <Grid className="item2" xs={12}></Grid>
          </Grid>
          <Grid className="column1" xs={3}>
            <Grid className="item1" xs={12}></Grid>
            <Grid className="item1" xs={12}></Grid>
        ...
        <Grid className="row2" xs={12}>
          <Grid className="item2" xs={3}></Grid>
          <Grid className="item2" xs={3}></Grid>
          <Grid className="item2" xs={3}></Grid>
          <Grid className="item2" xs={3}></Grid>
        </Grid>
